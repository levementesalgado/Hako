...
impl Parser {
    ...
    fn parse_assign_or_expr(&mut self) -> Result<Stmt, ParseError> {
        ...
        while let Some('[') | Some('(') = self.peek_char() {
    ...
    fn infer_type(&self, name: &str) -> String {
        match name {
            // String-like names
            "s" | "msg" | "str" | "text" | "message" | "fmt" | "format" | "name" | "label"
            | "title" | "desc" | "description" | "path" | "file" | "filename" | "url" | "uri"
            | "key" | "value_str" => "&str".into(),
            // Buffer-like names
            "data" | "buf" | "buffer" | "arr" | "array" | "list" | "items" | "bytes" | "slice"
            | "payload" | "packet" | "frame" | "block" | "sector" | "page" | "mem" | "memory" => {
                "&[u32]".into()
            }
            // Boolean-like names
            "flag" | "ok" | "valid" | "ready" | "done" | "found" | "exists" | "empty" | "full"
            | "open" | "closed" | "locked" | "enabled" | "disabled" | "active" | "verbose"
            | "debug" | "quiet" | "silent" => "bool".into(),
            // Float-like names
            "rate" | "ratio" | "percent" | "probability" | "chance" | "weight" | "score"
            | "value_f" | "x_f" | "y_f" | "pos_f" | "temp" | "temperature" | "speed"
            | "velocity" | "accel" | "force" => "f32".into(),
